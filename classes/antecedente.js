...
let antecedenteAcolito = new Antecedente(
  'ACÓLITO',
...
let antecedenteArtesao = new Antecedente(
  'ARTESÃO DE GUILDA',
...
let antecedenteArtista = new Antecedente(
  'ARTISTA',
...
let antecedenteCharlatao = new Antecedente(
  'CHARLATÃO',
...
let antecedenteCriminoso = new Antecedente(
  'CRIMINOSO',
...
let antecedenteEremita = new Antecedente(
  'EREMITA',
  [
...
let antecedenteForasteiro = new Antecedente(
  'FORASTEIRO',
...
let antecedenteHeroi = new Antecedente(
  'HERÓI DO POVO',
...
let antecedenteMarinheiro = new Antecedente(
  'MARINHEIRO',
...
let antecedenteMeninoRua = new Antecedente(
  'MENINO DE RUA',
...
let antecedenteNobre = new Antecedente(
  'NOBRE',
...
let antecedenteSabio = new Antecedente(
  'SÁBIO',
...
let antecedenteSoldado = new Antecedente(
  'SOLDADO',
