...
function run() {
	...
	*/
	...
	bgOutput += "<b style=\"font-size: large;\">Antecedente:</b>" + person.antecedente.nome + "<br>";
	...
	bgOutput += "<b>personalidades:</b>" + person.antecedente.personalidades[D8.rolar()] + '<br>';
	bgOutput += "<b>ideais:</b>" + person.antecedente.ideais[D6.rolar()] + '<br>';
	bgOutput += "<b>vínculos:</b>" + person.antecedente.vínculos[D6.rolar()] + '<br>';
	bgOutput += "<b>fraquezas:</b>" + person.antecedente.fraquezas[D6.rolar()] + '<br>';
	...
	*/
	...
	document.getElementById("nomepersonagem").innerHTML = 'teste';
